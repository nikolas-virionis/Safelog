...
function renderDependentes(search) {
    ...
    if (JSON.parse(sessionStorage.getItem("usuario"))?.cargo != "analista") {
        ...
        axios.post("/user/pessoas-dependentes", bodyObj).then(response => {
        ...
        if (search) bodyObj.search = search;
        axios
            .post("/machine/lista-dependentes/analista", bodyObj)
                ...
                if (status == "ok") {
                    if (dependentes.length > 0) {
                        dependentes.forEach(dependente => {
                            ...
                            if (
                                ...
                                editarBtn.addEventListener("click", () => {
                                    window.location.href = `machine-edit?id_maquina=${dependente.id_maquina}`;
                                });
                                ...
                                acessoBtn.addEventListener("click", () => {
                                    window.location.href = `machine-access?pk_maquina=${dependente.pk_maquina}`;
                                });
                        ...
                        document
                            ...
                            .addEventListener("click", e => {
                                axios
                                    .post("/user/remocao-proprio-acesso", {
                                        id: JSON.parse(
...
btnCadastroMaq.addEventListener("click", e => {
    window.location.href = "machine-register";
});
btnAtribuirMaq.addEventListener("click", e => {
    window.location.href = "link-machine";
});

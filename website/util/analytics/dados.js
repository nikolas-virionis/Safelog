...
const getStatsChamado = async ({
    ...
    if (type == "all") {
        ...
        chamados = `SELECT count(id_chamado) as chamadosTotais, (SELECT count(id_chamado) FROM chamado WHERE fk_categoria_medicao ${strId} AND status_chamado = 'aberto' AND fk_categoria_medicao ${strId} AND data_abertura ${strDate} ) as chamadosAbertos FROM chamado WHERE fk_categoria_medicao ${strId} AND data_abertura ${strDate} ORDER BY data_abertura DESC`;
        chamadosAzure = `SELECT count(id_chamado) as chamadosTotais, (SELECT count(id_chamado) FROM chamado WHERE fk_categoria_medicao ${strIdAzure} AND status_chamado = 'aberto' AND fk_categoria_medicao ${strIdAzure} AND data_abertura ${strDateAzure} ) as chamadosAbertos FROM chamado WHERE fk_categoria_medicao ${strIdAzure} AND data_abertura ${strDateAzure} ORDER BY data_abertura DESC`;
        ...
        chamados = `SELECT count(id_chamado) as chamadosTotais, (SELECT count(id_chamado) FROM chamado WHERE fk_categoria_medicao ${strId} AND status_chamado = 'aberto') as chamadosAbertos FROM chamado WHERE fk_categoria_medicao ${strId} ORDER BY data_abertura DESC LIMIT ${qtd}`;
        chamadosAzure = `SELECT TOP ${qtd} count(id_chamado) as chamadosTotais, (SELECT count(id_chamado) FROM chamado WHERE fk_categoria_medicao ${strIdAzure} AND status_chamado = 'aberto') as chamadosAbertos FROM chamado WHERE fk_categoria_medicao ${strIdAzure} ORDER BY data_abertura DESC`;
